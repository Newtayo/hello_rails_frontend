...
**[Hello react front end]** This a frontend of an application that displays five(5) random greetings

## [Link to the back-end repo](https://github.com/Newtayo/hello_rails_backend)
...
Feel free to check the [issues page](https://github.com/Newtayo/hello_rails_frontend/issues).
